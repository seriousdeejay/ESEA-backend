# Generated by Django 3.1.6 on 2021-05-13 17:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('description', models.TextField(blank=True, null=True)),
                ('datatype', models.CharField(choices=[('TEXT', 'Text'), ('INTEGER', 'Integer'), ('DOUBLE', 'Double'), ('DATE', 'Date')], default='TEXT', max_length=100)),
